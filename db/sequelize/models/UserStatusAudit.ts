...
interface UserStatusAuditCreationAttributes
    extends Optional<UserStatusAuditAttributes, "id" | "changed_at"> {}

export class UserStatusAudit
    extends Model<UserStatusAuditAttributes, UserStatusAuditCreationAttributes>
    implements UserStatusAuditAttributes
{
    public id!: number;
    ...
    static initialize(sequelize: Sequelize) {
        return UserStatusAudit.init(
            ...
            },
            {
                ...
                updatedAt: false,
                indexes: [{ fields: ["user_id"] }, { fields: ["changed_at"] }, { fields: ["new"] }],
            }
        );
    }

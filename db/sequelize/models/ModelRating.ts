...
interface ModelRatingCreationAttributes extends Optional<ModelRatingAttributes, 'created_at' | 'updated_at'> {}

export class ModelRating extends Model<ModelRatingAttributes, ModelRatingCreationAttributes> implements ModelRatingAttributes {

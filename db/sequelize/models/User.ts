...
export class User extends Model<UserAttributes, UserCreationAttributes> implements UserAttributes {
  ...
  static initialize(sequelize: Sequelize) {
    return User.init({
      ...
      status_id: { 
        ...
        allowNull: false, 
        // УБРАТЬ defaultValue для внешнего ключа
      },
  ...
  static associate(models: Models) {
    User.belongsTo(models.UserStatus, { 
      ...
      as: 'status',
      targetKey: 'id' // Явно указать целевой ключ
    });
    ...
    User.hasMany(models.UserStatusAudit, { foreignKey: 'changed_by', as: 'status_changes_made' });
  }
}

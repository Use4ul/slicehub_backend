...
interface ModelCommentCreationAttributes extends Optional<ModelCommentAttributes, 'id' | 'created_at'> {}

export class ModelComment extends Model<ModelCommentAttributes, ModelCommentCreationAttributes> implements ModelCommentAttributes {
  public id!: number;
  ...
  static associate(models: Models) {
    ...
    ModelComment.belongsTo(models.ModelComment, { foreignKey: 'parent_comment_id', as: 'parent' });
    ModelComment.hasMany(models.ModelComment, { foreignKey: 'parent_comment_id', as: 'replies' });
  }
}

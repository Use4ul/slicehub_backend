...
interface ModelPreviewCreationAttributes
    extends Optional<ModelPreviewAttributes, "id" | "created_at"> {}

export class ModelPreview
    extends Model<ModelPreviewAttributes, ModelPreviewCreationAttributes>
    implements ModelPreviewAttributes
{
    public id!: string;
    ...
    static associate(models: Models) {
        ...
        ModelPreview.belongsTo(models.StorageType, {

...
interface CommentAttachmentCreationAttributes extends Optional<CommentAttachmentAttributes, 'id' | 'created_at'> {}

export class CommentAttachment extends Model<CommentAttachmentAttributes, CommentAttachmentCreationAttributes> implements CommentAttachmentAttributes {
  public id!: string;

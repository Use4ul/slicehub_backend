...
export class AuthIdentity
    extends Model<AuthIdentityAttributes, AuthIdentityCreationAttributes>
    implements AuthIdentityAttributes
{
    public id!: string;
    ...
    static initialize(sequelize: Sequelize) {
        return AuthIdentity.init(
            ...
            },
            {
                ...
                underscored: true,
                timestamps: false,
                indexes: [{ fields: ["provider_id", "provider_user_id"], unique: true }],
            }
        );
    }

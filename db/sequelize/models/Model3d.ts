...
interface Model3dCreationAttributes
    extends Optional<Model3dAttributes, "id" | "created_at" | "updated_at"> {}

export class Model3d
    extends Model<Model3dAttributes, Model3dCreationAttributes>
    implements Model3dAttributes
{
    public id!: string;
    public title!: string;
    ...
    static associate(models: Models) {
        ...
        Model3d.belongsToMany(models.License, {
            through: models.ModelLicense,
            foreignKey: "model_id",
            as: "licenses",
        });
        Model3d.belongsToMany(models.Tag, {
        ...
        Model3d.belongsToMany(models.Collection, {

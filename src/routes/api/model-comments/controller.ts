...
router.post("/", validateBody(Models.CommentModel as any, { partial: false }), async (req: Request, res: Response) => {
	try {
...
router.put("/:id", validateBody(Models.CommentModel as any, { partial: true }), async (req: Request, res: Response) => {
	try {
